...
#Set your working directory after downloading and extracting the files
setwd("C:\Pooja\Coursera- R\Getting & Cleaning Data\Week 4\getdata_projectfiles_UCI HAR Dataset\UCI HAR Dataset")
